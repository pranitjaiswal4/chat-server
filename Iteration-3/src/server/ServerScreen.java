...
public class ServerScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(timestamp_ta, javax.swing.GroupLayout.DEFAULT_SIZE, 246, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(userListScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(userListScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 707, Short.MAX_VALUE)
                    .addComponent(textAreaScrollPane))
                .addContainerGap())
        );
    ...
    public void sendMessageBasedOnMessageType(String user, String message) {
        ...
        if (MESSAGE_TYPE.equals("Unicast")) {
            ...
            for (HandleClient c : clients) {
                if (c.getUserName().equalsIgnoreCase(UNICAST_USERNAME)) {        //if message_type is unicast then send message to intended receiver if online
    ...
    // Method to print new vector clock details sent by client
    private void printVectorOnMessageLog(String message) {
        ...
        // show message on message log
        chat_area_ta.append(datetime + "  :  " + message + "\n");
    }
    ...
    class HandleClient extends Thread {
        ...
        public void sendMessage(String uname, String msg) {
            printVectorOnMessageLog(uname + " to " + UNICAST_USERNAME + "  :  (" + msg + ")");
            output.println(uname + " to " + UNICAST_USERNAME + Constants.VECTOR_SPLITTER_KEYWORD + msg);
        }
